...
In an effort to help counteract buffer overflow exploitation, No Execute (AMD, aka NX) or Execute Disabled (Intel, aka XD)â€“ preventing code execution on per memory page basis on x86 processorsâ€“ should be enabled.
