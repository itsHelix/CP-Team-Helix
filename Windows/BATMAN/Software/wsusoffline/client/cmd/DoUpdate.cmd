...
if "%OS_NAME%"=="w100" (
  ...
  if %OS_VER_BUILD% GEQ 17134 goto SkipDotNet4Inst
)
...
if "%OS_NAME%"=="w60" (
  ...
  set DOTNET4_FILENAME=..\dotnet\NDP472-KB4054530-x86-x64-AllOS-ENU.exe
  set DOTNET4LP_FILENAME=..\dotnet\NDP472-KB4054530-x86-x64-AllOS-%OS_LANG%.exe
)
if "%OS_SRV_CORE%"=="1" (
