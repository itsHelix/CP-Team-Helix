...
cd %MYFILES%
tar -xf %MYFILES%\Meta.tar
tar -xf %MYFILES%\Software.tar
copy %MYFILES%\Meta\dialogboxes\MultipleChoiceBox.exe %windir%\system32\
copy %MYFILES%\Meta\dialogboxes \MultipleChoiceBox.cs %windir%\system32\
...
:break
copy /y /v %MYFILES%\Meta\Perfect\prefs.js %cd%
cls
...
dir /B "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\" >> %MYFILES%\Output\deletedfiles.txt
del /S "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\*" /F /Q
dir /B "C:\Users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\" >> %MYFILES%\Output\deletedfiles.txt
...
if /I "%Operating%" EQU "false" goto Server
  ...
  "%MYFILES%\Meta\LGPO.exe" /m "%MYFILES%\Meta\Perfect\DomainSysvol\GPO\Machine\registry.pol"
  "%MYFILES%\Meta\LGPO.exe" /u "%MYFILES%\Meta\Perfect\DomainSysvol\GPO\User\registry.pol"
  "%MYFILES%\Meta\LGPO.exe" /s "%MYFILES%\Meta\Perfect\DomainSysvol\GPO\Machine\microsoft\windows nt\SecEdit\GptTmpl.inf"
  "%MYFILES%\Meta\LGPO.exe" /ac "%MYFILES%\Meta\Perfect\DomainSysvol\GPO\Machine\microsoft\windows nt\Audit\audit.csv"
...
:Server
  :: Windows Server
  "%MYFILES%\Meta\LGPO.exe" /m "%MYFILES%\Meta\Perfect\ServerDomainSysvol\GPO\Machine\registry.pol"
  "%MYFILES%\Meta\LGPO.exe" /u "%MYFILES%\Meta\Perfect\ServerDomainSysvol\GPO\User\registry.pol"
  "%MYFILES%\Meta\LGPO.exe" /s "%MYFILES%\Meta\Perfect\ServerDomainSysvol\GPO\Machine\microsoft\windows nt\SecEdit\GptTmpl.inf"
  "%MYFILES%\Meta\LGPO.exe" /ac "%MYFILES%\Meta\Perfect\ServerDomainSysvol\GPO\Machine\microsoft\windows nt\Audit\audit.csv"

:AfterServerPol

:Software
if /I "%Software%" EQU "Y" (
	start %MYFILES%\Meta\"Ninite - Everything Firefox Glary Malwarebytes Installer.exe"
)
...
if /I "%Users%" EQU "Y" (
	...
	copy %MYFILES%\Meta\users.ps1 %USERPROFILE%\desktop
