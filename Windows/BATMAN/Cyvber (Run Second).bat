...
echo    7. Input
echo    8. Find All Media Files
echo    9. Move All Media Files
echo __________________________________

REM Fetch option
CHOICE /C 123456789 /M "Enter your choice:"
if ERRORLEVEL 9 goto MoveMediaFiles
if ERRORLEVEL 8 goto FindMediaFiles
if ERRORLEVEL 7 goto Input
if ERRORLEVEL 6 goto MISCELLANEOUS
if ERRORLEVEL 5 goto SCHEDULED-TASKS
if ERRORLEVEL 4 goto FIREWALL
if ERRORLEVEL 3 goto GROUP-POLICY
...
set /p choice=do you want to find files with this[Y/N]
if /I "%choice%" EQU "Y"(
:FindMediaFilesHelper
attrib -h -s -r C:\*.%~1
dir /a /s /b C:\*.%~1 >> Output\mediafiledirectories.txt

:FindMediaFiles
CALL :FindMediaFilesHelper mp3
CALL :FindMediaFilesHelper wav
CALL :FindMediaFilesHelper m4a
CALL :FindMediaFilesHelper ogg
CALL :FindMediaFilesHelper avi
CALL :FindMediaFilesHelper mp4
CALL :FindMediaFilesHelper flv
CALL :FindMediaFilesHelper wmv
CALL :FindMediaFilesHelper mov
CALL :FindMediaFilesHelper webm
CALL :FindMediaFilesHelper mpg
CALL :FindMediaFilesHelper rar
CALL :FindMediaFilesHelper pdf
CALL :FindMediaFilesHelper docx
CALL :FindMediaFilesHelper doc
CALL :FindMediaFilesHelper midi
CALL :FindMediaFilesHelper dma
CALL :FindMediaFilesHelper asf
CALL :FindMediaFilesHelper wma
CALL :FindMediaFilesHelper wm
CALL :FindMediaFilesHelper asx
CALL :FindMediaFilesHelper wax
CALL :FindMediaFilesHelper wvx
CALL :FindMediaFilesHelper wmx
CALL :FindMediaFilesHelper dvr-ms
CALL :FindMediaFilesHelper wmd
CALL :FindMediaFilesHelper mpeg
CALL :FindMediaFilesHelper m1v
CALL :FindMediaFilesHelper mp2
CALL :FindMediaFilesHelper mpa
CALL :FindMediaFilesHelper mpem3u
CALL :FindMediaFilesHelper mid
CALL :FindMediaFilesHelper rmi
CALL :FindMediaFilesHelper aif
CALL :FindMediaFilesHelper aifc
CALL :FindMediaFilesHelper aiff
CALL :FindMediaFilesHelper au
CALL :FindMediaFilesHelper snd
CALL :FindMediaFilesHelper cda
CALL :FindMediaFilesHelper ivf
CALL :FindMediaFilesHelper wmz
CALL :FindMediaFilesHelper wms
CALL :FindMediaFilesHelper m4v
CALL :FindMediaFilesHelper mp4v
CALL :FindMediaFilesHelper 3g2
CALL :FindMediaFilesHelper 3gp2
CALL :FindMediaFilesHelper 3gp
CALL :FindMediaFilesHelper 3gpp
CALL :FindMediaFilesHelper adt
CALL :FindMediaFilesHelper adts
CALL :FindMediaFilesHelper m2ts
CALL :FindMediaFilesHelper raw
CALL :FindMediaFilesHelper hdp
CALL :FindMediaFilesHelper wdp
CALL :FindMediaFilesHelper torrent

:MoveMediaFiles
for /F "tokens=*" %%A in (Output\mediafiledirectories.txt) do move %%A Output\mediafiles\
) else (exit)
